  ...
  <div class="w-full md:w-1/2">
    ...
    >
      ...
      <form action="#" class="font-general-regular space-y-7">
        <FormInput label="姓名" inputIdentifier="name" />
        <FormInput label="邮箱" inputIdentifier="email" inputType="email" />
        <FormInput label="主题" inputIdentifier="subject" />
        <FormTextarea label="备注" textareaIdentifier="message" />
